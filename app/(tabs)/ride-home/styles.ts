...
StyleSheet.create({
  ...
  searchSuggestionPanel: { backgroundColor: '#F8FAFA', borderColor: '#DCE7F3', borderWidth: 1, borderRadius: 18, padding: 8, marginBottom: 10, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  searchSuggestionItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 12, borderRadius: 16, backgroundColor: '#FFFFFF', marginBottom: 8, borderWidth: 1, borderColor: '#E2E8F0', minHeight: 56 },
  searchSuggestionIconWrap: { width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: '#EEF4FF', marginRight: 10, flexShrink: 0 },
  searchSuggestionTextWrap: { flex: 1, minWidth: 0 },
  searchSuggestionTitle: { color: '#0F172A', fontSize: 14, fontWeight: '800', lineHeight: 18 },
  searchSuggestionSubtitle: { color: '#64748B', fontSize: 12, lineHeight: 16, marginTop: 2 },
  searchSuggestionEmptyText: { color: '#64748B', fontSize: 13, fontWeight: '600', textAlign: 'center', paddingVertical: 6 },
  searchSuggestionErrorText: { color: '#B91C1C', fontSize: 13, fontWeight: '700', textAlign: 'center', paddingVertical: 6 },
